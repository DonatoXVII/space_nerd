...
<div class="formEFiltri">
    <div class="filtriInserimento">
        <form action="AdminControl?action=verificaTipo" method="post">
            <br><br><br>
            <label>
                <input type="radio" name="prod" value="manga" class="tipo" required> Manga
            </label><br>
            <label>
                <input type="radio" name="prod" value="pop" class="tipo" required> Pop
            </label><br>
            <label>
                <input type="radio" name="prod" value="figure" class="tipo" required> Figure
            </label><br><br><br>
            <button type="submit" class="confermaTipo">
                <svg
